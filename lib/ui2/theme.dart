...
class P {
  ...
  Color get bg => dark ? const Color(0xFF080C14) : C.n50;
  Color get card => dark ? const Color(0xFF131A26) : C.white;
  Color get card2 => dark ? const Color(0xFF1B2433) : C.n100;
  Color get line => dark ? const Color(0xFF232D3B) : C.n200;
  Color get track => dark ? const Color(0xFF232D3B) : C.n200;

  // Liquid Glass Tokens (iOS frosted glassmorphism)
  Color get glassCard => dark ? const Color(0x40162030) : const Color(0xC7FFFFFF);
  Color get glassCardSubtle => dark ? const Color(0x26162030) : const Color(0x99FFFFFF);
  Color get glassBorderTop => dark ? const Color(0x45FFFFFF) : const Color(0x73FFFFFF);
  Color get glassBorderBottom => dark ? const Color(0x12FFFFFF) : const Color(0x14000000);
  Color get glassNav => dark ? const Color(0x8A080C14) : const Color(0xAAFFFFFF);
  Color get glassGlow => dark ? const Color(0x2E00F2B6) : const Color(0x1A00F2B6);
